...
class MetadataViewer(QWidget):
    ...
    def __init__(self, presenter, parent=None):
        ...
        # Connect signals
        self.plot_model.collection.visible_runs_changed.connect(self._update_metadata)
    ...
    def _update_metadata(self, selected_runs):
        ...
        self.metadata_model.update_metadata(self.plot_model.collection.visible_models)
    ...
    def _get_run_for_index(self, index):
        if not index.isValid():
            runs = self.plot_model.collection.visible_models
